...
class ARCH_g2():	
	...
	def generator_model_densebias_g2(self):
		init_fn = tf.random_normal_initializer(mean=0.0, stddev=2.5, seed=None)
		# init_fn = tf.keras.initializers.glorot_uniform()
		init_fn = tf.function(init_fn, autograph=False)
		bias_init_fn = tf.random_normal_initializer(mean=0.0, stddev=5.0, seed=None)
		bias_init_fn = tf.function(bias_init_fn, autograph=False)
		...
		enc4 = tf.keras.layers.Dense(self.output_size, kernel_initializer=init_fn, use_bias = True)(enc3)
