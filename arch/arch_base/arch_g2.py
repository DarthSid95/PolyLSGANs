...
class ARCH_g2():
	...
	def show_result_g2(self, images = None, num_epoch = 0, path = 'result.png', show = False, save = True):
		...
		with PdfPages(path+'_Classifier.pdf') as pdf:
			...
			ax1.scatter(self.reals[::5,0], self.reals[::5,1], c='r', linewidth = 0.5, s = 15,  marker = '.', alpha = 0.8)
			ax1.scatter(self.fakes[::5,0], self.fakes[::5,1], c='g', linewidth = 0.5, s = 15,  marker = '.', alpha = 0.8)
