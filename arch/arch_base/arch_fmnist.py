...
class ARCH_fmnist():
	...
	def __init__(self):
		print("Creating FMNIST architectures for base cases ")
		return


	def generator_model_dense_fmnist(self):
	...
	def discriminator_model_dense_fmnist(self):
	...
	def generator_model_dcgan_fmnist(self):
		init_fn = tf.keras.initializers.glorot_uniform()
		init_fn = tf.function(init_fn, autograph=False)
	...
	def discriminator_model_dcgan_fmnist(self):
		init_fn = tf.keras.initializers.glorot_uniform()
		init_fn = tf.function(init_fn, autograph=False)
